...
export class ChampionCardComponent {
  ...
  placeholderChamp: Champion = {
    ...
    skins: [
      ...
      { id: '266007', num: 7, name: 'Blood Moon Aatrox', chromas: true },
      { id: '266008', num: 8, name: 'Prestige Blood Moon Aatrox', chromas: false },
      ...
      { id: '266021', num: 21, name: 'Lunar Eclipse Aatrox', chromas: true },
      { id: '266030', num: 30, name: 'DRX Aatrox', chromas: true },
      { id: '266031', num: 31, name: 'Prestige DRX Aatrox', chromas: false },
      { id: '266033', num: 33, name: 'Primordian Aatrox', chromas: true },
    ],
    ...
    spells: [
      ...
      },
      {
        ...
        tooltip:
          '<spellPassive>Passive:</spellPassive> Aatrox heals for <lifeSteal>{{ totalevamp }}</lifeSteal> of the damage he deals to Champions.<br /><br /><spellActive>Active:</spellActive> Aatrox dashes. He can use this Ability while winding up his other Abilities.{{ spellmodifierdescriptionappend }}',
        leveltip: { label: ['Cooldown'], effect: ['{{ cooldown }} -> {{ cooldownNL }}'] },
        maxrank: 5,
        cooldown: [9, 8, 7, 6, 5],
  ...
  currentChamp = signal(this.placeholderChamp);

  champModal(): void {
    this.isModalActive.set(true);
    this.currentChamp.set(this.champion);
  }
